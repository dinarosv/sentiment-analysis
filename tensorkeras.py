...
# Layers
model.add(LSTM(units=12, dropout=0.1, recurrent_dropout=0.1))
...
model.fit(x_train_pad, y_train, validation_split=0.05, epochs=10, batch_size=512, callbacks=[tensorboard])
